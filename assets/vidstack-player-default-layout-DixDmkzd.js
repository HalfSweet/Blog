const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/vidstack-BTigPj2h-C4kif2Zo.js","assets/app-Ber8O4XS.js"])))=>i.map(i=>d[i]);
var vs=Object.defineProperty;var fs=Object.getPrototypeOf;var hs=Reflect.get;var pe=e=>{throw TypeError(e)};var $s=(e,t,s)=>t in e?vs(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var P=(e,t,s)=>$s(e,typeof t!="symbol"?t+"":t,s),Gt=(e,t,s)=>t.has(e)||pe("Cannot "+s);var v=(e,t,s)=>(Gt(e,t,"read from private field"),s?s.call(e):t.get(e)),b=(e,t,s)=>t.has(e)?pe("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),D=(e,t,s,n)=>(Gt(e,t,"write to private field"),n?n.call(e,s):t.set(e,s),s),h=(e,t,s)=>(Gt(e,t,"access private method"),s);var Lt=(e,t,s)=>hs(fs(e),s,t);import{g as x,p as be,h as _,i as at,j as ge,k as bs,u as C,l as R,m as gs,C as ys,n as xs,q as w,t as ye,v as Ss,x as xe,y as g,z as Ts,A as Yt,B as Se,D as st,E as Te,F as ws,G as ks,H as Cs,I as we,J as bt,K as ot,L as As,M as Ds,N as Ms,O as Is,$ as Os,P as V,Q as Ps,R as _s,_ as Gs,S as ke,T as Nt,U as Ls,V as Ns,W as Bs,X as Fs,Y as Ce}from"./app-Ber8O4XS.js";import{A as W,T as Vs,D as me,x as l,s as Rs,L as Ae}from"./vidstack-CwTj4H1w-BCQqYYxA.js";/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let Rt=class extends Zt{constructor(t){if(super(t),this.et=W,t.type!==gt.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===W||t==null)return this.ft=void 0,this.et=t;if(t===Vs)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.et)return this.ft;this.et=t;const s=[t];return s.raw=s,this.ft={_$litType$:this.constructor.resultType,strings:s,values:[]}}};Rt.directiveName="unsafeHTML",Rt.resultType=1;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
  ...
  `}function Un(){return a(()=>{const{live:e,duration:t}=g();return e()?Re():t()?l`<media-time class="vds-time" type="current" toggle remainder></media-time>`:null})}function je(){return a(()=>{const{live:e}=g();return e()?Re():Hn()})}function Ye(){return a(()=>{const{textTracks:e}=C(),{title:t,started:s}=g(),n=w(null);return we(e,"chapters",n.set),n()&&(s()||!t())?Xe():l`<media-title class="vds-chapter-title"></media-title>`})}function Xe(){return l`<media-chapter-title class="vds-chapter-title"></media-chapter-title>`}class Ze extends Zs{async loadIcons(){const t=(await Gs(async()=>{const{icons:n}=await import("./vidstack-BTigPj2h-C4kif2Zo.js");return{icons:n}},__vite__mapDeps([0,1]))).icons,s={};for(const n of Object.keys(t))s[n]=Ys({name:n,paths:t[n]});return s}}var F;let zn=(F=class extends Ct{},P(F,"props",{...Lt(F,F,"props"),when:({viewType:t})=>t==="audio",smallWhen:({width:t})=>t<576}),F);function qn(){return[Jt(),ne(),l`
    ...
    `]}function jn(){return a(()=>{let e=w(void 0),t=w(!1),s=C(),{title:n,started:i,currentTime:o,ended:r}=g(),{translations:p}=u(),c=Ns(e),y=()=>i()||o()>0;const f=()=>{const S=r()?"Replay":y()?"Continue":"Play";return`${k(p,S)}: ${n()}`};_(()=>{var S;c()&&document.activeElement===document.body&&((S=s.player.el)==null||S.focus({preventScroll:!0}))});function m(){const S=e(),T=!!S&&!c()&&S.clientWidth<S.children[0].clientWidth;S&&Bs(S,"vds-marquee",T),t.set(T)}function $(){return l`
      ...
      `}return xe(e,m),n()?l`
        ...
        `:L()})}function Yn(){const e="top end";return[Ke({tooltip:"top",placement:e,portal:!0}),qe({tooltip:"top end",placement:e,portal:!0})]}var mt,X,A,Je,ts,es,ss,ns,is;class zt extends ke(Ae,zn){constructor(){super(...arguments);b(this,A);b(this,mt);b(this,X,w(!1))}onSetup(){this.forwardKeepAlive=!1,D(this,mt,C()),this.classList.add("vds-audio-layout"),h(this,A,es).call(this)}onConnect(){Be("audio",()=>this.isMatch),h(this,A,ts).call(this)}render(){return a(h(this,A,Je).bind(this))}}mt=new WeakMap,X=new WeakMap,A=new WeakSet,Je=function(){return this.isMatch?qn():null},ts=function(){const{menuPortal:s}=u();_(()=>{if(!this.isMatch)return;const n=Ee(this,this.menuContainer,"vds-audio-layout",()=>this.isSmallLayout),i=n?[this,n]:[this];return(this.$props.customIcons()?new _e(i):new Ze(i)).connect(),s.set(n),()=>{n.remove(),s.set(null)}})},es=function(){const{pointer:s}=v(this,mt).$state;_(()=>{s()==="coarse"&&_(h(this,A,ss).bind(this))})},ss=function(){if(!v(this,X).call(this)){Nt(this,"pointerdown",h(this,A,ns).bind(this),{capture:!0});return}Nt(this,"pointerdown",s=>s.stopPropagation()),Nt(window,"pointerdown",h(this,A,is).bind(this))},ns=function(s){const{target:n}=s;Ls(n)&&n.closest(".vds-time-slider")&&(s.stopImmediatePropagation(),this.setAttribute("data-scrubbing",""),v(this,X).set(!0))},is=function(){v(this,X).set(!1),this.removeAttribute("data-scrubbing")},P(zt,"tagName","media-audio-layout"),P(zt,"attrs",{smallWhen:{converter(s){return s!=="never"&&!!s}}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Xn=wt(class extends Zt{constructor(){super(...arguments),this.key=W}render(e,t){return this.key=e,t}update(e,[t,s]){return t!==this.key&&(Qs(e),this.key=t),s}}),it=class it extends Ct{};P(it,"props",{...Lt(it,it,"props"),when:({viewType:t})=>t==="video",smallWhen:({width:t,height:s})=>t<576||s<380});let qt=it;function as(){return a(()=>{const e=C(),{noKeyboardAnimations:t,userPrefersKeyboardAnimations:s}=u();if(x(()=>t()||!s())())return null;const i=w(!1),{lastKeyboardAction:o}=e.$state;_(()=>{i.set(!!o());const m=setTimeout(()=>i.set(!1),500);return()=>{i.set(!1),window.clearTimeout(m)}});const r=x(()=>{var $;const m=($=o())==null?void 0:$.action;return m&&i()?ot(m):null}),p=x(()=>`vds-kb-action${i()?"":" hidden"}`),c=x(Zn),y=x(()=>{const m=Jn();return m?Fs(m):null});function f(){const m=y();return m?l`
  ...
  `}function re(){const{menuGroup:e,smallWhen:t}=u(),s=()=>e()==="top"||t()?"bottom":"top",n=x(()=>`${s()} ${e()==="top"?"end":"center"}`),i=x(()=>`${s()} end`);return[Ke({tooltip:n,placement:i,portal:!0}),qe({tooltip:n,placement:i,portal:!0})]}function os(){return a(()=>{const{noGestures:e}=u();return e()?null:l`
    ...
    `})}var Z,J,ls,rs;class jt extends ke(Ae,qt){constructor(){super(...arguments);b(this,J);b(this,Z)}onSetup(){this.forwardKeepAlive=!1,D(this,Z,C()),this.classList.add("vds-video-layout")}onConnect(){Be("video",()=>this.isMatch),h(this,J,ls).call(this)}render(){return a(h(this,J,rs).bind(this))}}Z=new WeakMap,J=new WeakSet,ls=function(){const{menuPortal:s}=u();_(()=>{if(!this.isMatch)return;const n=Ee(this,this.menuContainer,"vds-video-layout",()=>this.isSmallLayout),i=n?[this,n]:[this];return(this.$props.customIcons()?new _e(i):new Ze(i)).connect(),s.set(n),()=>{n.remove(),s.set(null)}})},rs=function(){const{load:s}=v(this,Z).$props,{canLoad:n,streamType:i,nativeControls:o}=v(this,Z).$state;return!o()&&this.isMatch?s()==="play"&&!n()?ii():i()==="unknown"?Pt():this.isSmallLayout?ni():ti():null},P(jt,"tagName","media-video-layout"),P(jt,"attrs",{smallWhen:{converter(s){return s!=="never"&&!!s}}});Ce(zt);Ce(jt);
