...
Stable diffusion model failed to load, exiting
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,20),C={href:"https://www.bilibili.com/read/cv19182425",target:"_blank",rel:"noopener noreferrer"},z=e("br",null,null,-1),F=e("img",{src:v,alt:"",loading:"lazy"},null,-1),S=e("br",null,null,-1),U=e("img",{src:b,alt:"",loading:"lazy"},null,-1),T=e("p",null,"经过重新检查文件完整性的操作，问题修复。",-1),P=e("figure",null,[e("img",{src:p,alt:"",tabindex:"0",loading:"lazy"}),e("figcaption")],-1);function L(N,E){const n=a("ExternalLinkIcon");return o(),t("div",null,[h,r(" more "),_,g,w,e("p",null,[e("a",k,[i("stable-diffusion-webui"),l(n)]),i("是一个基于用于稳定扩散的 Gradio 库的浏览器界面，作用是将泄露出来的novelAI模型以一个可视化比较好的方式进行训练与导出。")]),y,e("p",null,[i("请选择一个或者多个您喜欢的模型下载，如果您对不同的模型区别有疑问，可以参考这个"),e("a",x,[i("链接"),l(n)]),i("。")]),q,e("p",null,[e("s",null,[i("前往"),e("a",I,[i("PyTorch官网"),l(n)]),i("，查找适合您电脑CUDA驱动的版本（您可以通过命令"),A,i("查看当前电脑的CUDA驱动版本，并安装低于CUDA版本的PyTorch）。在这里，我们安装1.12.1版本，使用CUDA 11.6的PyTorch（使用别的版本请自行替换命令）。")])]),D,e("p",null,[i("经过"),e("a",C,[i("b站一位大佬"),l(n)]),i("发的Hash对照来看，发现是使用比特彗星下载的文件的Hash不对，但是很神奇的是stable-diffusion-webui的计算的8位正确。"),z,F,S,U]),T,P])}const W=s(f,[["render",L],["__file","index.html.vue"]]);export{W as default};
